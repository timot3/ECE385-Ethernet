 ...
 *
 *   This class provides formatted printing into memory. Users can use it to
 * write into send buffers.
 *
 *   Nota: PGM_P: is a pointer to a string in program space (defined in the
 * source code, updated to PROGMEM)
 *
 *   # Format string
 *
...
public:
   ...
   *   @param  n Number of characters to copy
   */
  //    void emit_raw_p (const char* p, uint16_t n) { memcpy_P(ptr, p, n); ptr
  //    += n; }
